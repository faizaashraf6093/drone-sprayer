...
class ResultProduct extends StatelessWidget {
  const ResultProduct({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Product Calculations Result'),
        ),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        CustomRow(
                          text: 'Total pesticide required: ',
                          answer: '${result[0]} L',
                        ),
                        CustomRow(
                          text: 'Area sprayed by one tank: ',
                          answer: '${result[1]} a',
                        ),
                        CustomRow(
                          text: 'Pesticide required per tank:',
                          answer: '${result[2]} L',
                        ),
                      ],
                    ),
